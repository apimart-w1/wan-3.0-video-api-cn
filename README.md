# Wan 3.0 API 中文文档：模型 ID、每秒价格与调用示例
...
## 为什么通过 APIMart 调用 Wan 3.0

- **一把 key 通吃全目录。** 同一套 base URL 与鉴权头可访问 Wan 3.0 以及目录里 300 多个图像、视频、语言模型，换模型只改 `model` 字段。
...
| 输出档位 | file | 花费 | prompt |
| --- | --- | --- | --- |
| <img src="assets/01-preview-thumb.jpg" width="260"> | [01-preview.mp4](assets/01-preview.mp4) | $0.1644 | `海边悬崖上的现代别墅，黄昏，泳池倒映天空，缓慢推镜` |
